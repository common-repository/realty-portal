...
= 0.3.3 =
* Fix Single proeperty print function
* Fix Advanced search function.

= 0.3.4 =
* Fix Advanced search multiple field select.

= 0.3.5 =
* Add field agent_address to global properties
* Add new filter rp_submit_comment_response
* Improve custom field multiple select
* [FIX BUG] Replace unsupported query prepare placeholder %1$d with %d to fix broken queries. Fixes compatibility issue with WordPress 4.8.2.
...
= 0.3.7 =
* Fix multiple select
* Fix Payment Calculator widget

= 0.3.7.1 =
* Reorder property page details content.
* Fix property listing widget issue.

= 0.3.8 =
* Improve propery image upload.
* Fix property area search field.
* Fix search field issue.
* Add new currency.


= 0.4.1 =
* Fix Envato Theme Check issues