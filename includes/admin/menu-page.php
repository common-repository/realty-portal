...
function rp_menu_setting_page() {
    ...
    add_submenu_page(
        'realty-portal-setting',
        esc_html__( 'Quick Setup', 'realty-portal' ),
        esc_html__( 'Quick Setup', 'realty-portal' ),
        'manage_options',
        'realty-portal-quick-setup',
        'rp_load_page_quick_setup_template'
    );
...
if(!function_exists('rp_load_page_quick_setup_template')):
    function rp_load_page_quick_setup_template(){
        require'page/quick-setup.php';
    }
endif;
