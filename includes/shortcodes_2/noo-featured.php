...
if ( ! function_exists( 'noo_shortcode_featured' ) ) :
	...
	function noo_shortcode_featured( $atts ) {
		...
		extract( shortcode_atts( array(
			...
			'sub_title' => '',
			'id'        => '',
			'caption'   => esc_html__( 'Featured', 'realty-portal' ),
		), $atts ) );
			...
			if ( ! empty( $id ) && isset( $id ) ) {
				...
				<div class="noo-featured-main">
					...
					<div class="noo-view">
						...
						echo '<a class="noo-readmore" href="' . esc_url( get_permalink() ) . '">' . esc_html__( 'Read more', 'realty-portal' ) . '</a>';
						?>
					</div>
				...
				echo '<p>' . esc_html__( 'Nothings!', 'realty-portal' ) . '</p>';
			}
