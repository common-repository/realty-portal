...
if ( !function_exists( 'noo_shortcode_advanced_search_property' ) ) :
    ...
    function noo_shortcode_advanced_search_property( $atts ) {
        ...
        $list_option = array(
            ...
            'title'                 => esc_html__( 'Find Property', 'realty-portal' ),
            'sub_title'             => '',
            ...
            'text_show_features'    => esc_html__( 'More Filters', 'realty-portal' ),
            'text_button_search'    => esc_html__( 'Search Property', 'realty-portal' ),
        );
                ...
                <form class="noo-advanced-search-property-form <?php echo esc_attr( $class_form ) ?>" action="<?php echo esc_url( $url_page_property_search ) ?>" method="get" accept-charset="utf-8">
                    ...
                    <div class="noo-advanced-search-property-top-wrap">
                        <div class="noo-advanced-search-property-top">
                            ...
                            $args_address = array(
                                ...
                                'title'       => '',
                                'type'        => 'text',
                                'placeholder' => esc_html__( 'Enter an address, town, street, or zip ...', 'realty-portal' ),
                            ...
                            <button type="submit">
                                ...
                                <?php echo esc_html__( 'Search', 'realty-portal' ); ?>
                            </button>
                    ...
                    <?php
                        ...
                        if ( $show_map === 'yes' ) {
                            ...
                            ?>
                                    <div class="gmap-loading"><?php echo esc_html__( 'Loading Maps', 'realty-portal' ); ?>
                                ...
                                <div class="gmap-controls-wrap <?php echo 'true' == $show_controls ? ' hidden' : ''; ?>">
                                    <div class="gmap-controls">
                                        <div class="map-view">
                                            <i class="fa fa-picture-o"></i>
                                            <?php echo esc_html__( 'View', 'realty-portal' ); ?>
                                            <span class="map-view-type">
                                                <span data-type="roadmap">
                                                    <?php echo esc_html__( 'Roadmap', 'realty-portal' ); ?>
                                                </span>
                                                <span data-type="satellite">
                                                    <?php echo esc_html__( 'Satellite', 'realty-portal' ); ?>
                                                </span>
                                                <span data-type="hybrid">
                                                    <?php echo esc_html__( 'Hybrid', 'realty-portal' ); ?>
                                                </span>
                                                <span data-type="terrain">
                                                    <?php echo esc_html__( 'Terrain', 'realty-portal' ); ?>
                                                </span>
                                            </span>
                                        </div>
                                        <div class="my-location" id="<?php echo esc_attr( uniqid( 'my-location-' ) ) ?>">
                                            <i class="fa fa-map-marker"></i>
                                            <?php echo esc_html__( 'My Location', 'realty-portal' ); ?>
                                        </div>
                                        <div class="gmap-full">
                                            <i class="fa fa-expand"></i> 
                                            <?php echo esc_html__( 'Fullscreen', 'realty-portal' ); ?>
                                        </div>
                                        <div class="gmap-prev">
                                            <i class="fa fa-chevron-left"></i> 
                                            <?php echo esc_html__( 'Prev', 'realty-portal' ); ?>
                                        </div>
                                        <div class="gmap-next">
                                            <?php echo esc_html__( 'Next', 'realty-portal' ); ?>
                                    ...
                                    <div class="box-search-map">
                                        <input type="text" id="gmap_search_input" name="find-address-map" placeholder="<?php echo esc_html__( 'Google Maps Search', 'realty-portal' ); ?>"  autocomplete="off" />
                                    </div>
                                </div>
                                <?php
                        }
                    ...
                    <div class="noo-advanced-search-property-wrap">
                        <div class="noo-action-search-top">
                            ...
                            <button type="submit" class="show-filter-property">
                                <?php echo wp_kses( __( 'We found <b>0</b> results. Do you want to load the results now?', 'realty-portal' ), noo_allowed_html() ); ?>
                            </button>
                        </div>
                    ...
                    <?php endif; ?>
                   <!--  <?php if ( is_front_page() && (ICL_LANGUAGE_CODE)!="null" ) : ?>
