...
if ( !function_exists( 'noo_shortcode_single_agent_contact' ) ) :
    ...
    function noo_shortcode_single_agent_contact( $atts ) {
        ...
        <div class="noo-agent-contact">
            ...
            <h2 class="noo-title"><?php echo esc_html__( 'Contact info', 'realty-portal' ); ?></h2>
            <div class="noo-box-form">
                ...
                <?php if ( $contact_form ) :
                    ...
                    <form class="noo-box-contact-agent">
                        ...
                        <div class="noo-row">
                            <div class="noo-md-4 noo-sm-12  noo-item-wrap noo-box-text-field">
                                <input type="text" name="name" placeholder="<?php echo esc_html__( 'Name *', 'realty-portal' ); ?>" />
                            </div>
                            <div class="noo-md-4 noo-sm-12 noo-item-wrap noo-box-text-field">
                                <input type="text" name="phone" placeholder="<?php echo esc_html__( 'Phone', 'realty-portal' ); ?>" />
                            </div>
                            <div class="noo-md-4 noo-sm-12 noo-item-wrap noo-box-text-field">
                                <input type="text" name="email" placeholder="<?php echo esc_html__( 'Email *', 'realty-portal' ); ?>" />
                            </div>
                        </div>
                        <div class="noo-item-wrap noo-box-textarea-field">
                            <textarea name="message" placeholder="<?php echo esc_html__( 'Your Message *', 'realty-portal' ); ?>"></textarea>
                        </div>
                        ...
                        <div class="noo-form-action">
                            <button type="submit" class="noo-submit">
                                <span><?php echo esc_html__( 'Send Message', 'realty-portal' ); ?></span>
