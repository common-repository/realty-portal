            ...
            <?php if ( 'true' == $slider ) : ?>
                ...
                <div class="rp-upload-main">
                    ...
                    <div class="rp-list-image">
                        ...
                        ?>
                        <div class="item-image" id="item-image-<?php echo esc_attr( $id ) ?>">
                    ...
                    <div class="rp-upload-right rp-md-3">
                        <span class="btn-upload" id="<?php echo esc_attr( $id_upload ) ?>">
                ...
                <div class="rp-upload-main">
                    ...
                    <div class="rp-upload-action">
                        ...
                        if ( ! empty( $notice ) ) :
                         ...
                         <?php if($show_btn): ?>
                                <span class="rp-upload-image rp-button btn-upload" id="<?php echo esc_attr( $id_upload ) ?>"><?php echo esc_html( $btn_text ); ?></span>
                            <?php endif; ?>
                    </div>
...
if (!function_exists('rp_upload_url')):
	function rp_upload_url() {
		$upload_dir = wp_upload_dir();
