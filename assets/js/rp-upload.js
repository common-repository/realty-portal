...
(function ($) {
    ...
    $.fn.rp_upload_form = function (options) {
        ...
        var dragdrop = false;
        var multiple_queues = false;
        var urlstream_upload = false;
        var multipart = false;
        ...
        var uploader = new plupload.Uploader({
            ...
            browse_button: form_upload.find('#' + options.browse_button)[0],
            ...
            urlstream_upload: urlstream_upload,
            multipart: multipart,
            ...
            init: {
                    ...
                    if (options.slider) {
                        ...
                        plupload.each(files, function (file) {
                            ...
                            img_preview.onembedded = function () {
                                var form_wrapper = $("#rp-property-submit");
                                form_wrapper.block({
                                 ...
                                 */
                                var content_img = '<div class="item-image" id="item-image-' + id_img + '"><img src="' + url_img + '"><i class="rp-icon-trash"></i></div>';
                ...
                UploadProgress: function (up, file) {
                    ...
                    if (options.slider) {
                        ...
                        var upload_wrapper = $(".rp-upload-wrap");
                        upload_wrapper.block({
                            message: null, overlayCSS: {
                                backgroundColor: '#fff',
                                opacity: 0.5,
                                cursor: 'wait'
                ...
                FileUploaded: function (up, file, response) {
                    ...
                    if (options.slider) {
                        ...
                        if (data.status == 'success') {
                            ...
                            var icon_remove = '<i class="remove-item rp-icon-trash" data-id="' + data.id + '"></i>';

                            /**
                             * Find current image and add data
                             */
                            if (container_wrap.find('#' + id_image_wrap).length > 0) {
                                container_wrap.find('#' + id_image_wrap).html(
                                    '<img src="' + data.url + '">' + icon_remove + html_results
                                );
                            }
